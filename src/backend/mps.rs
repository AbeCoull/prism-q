...
fn cut_rank(bond_left: usize, bond_mid: usize, bond_right: usize) -> u128 {
...
fn widest_block_cut(bond_left: usize, bond_right: usize, n: usize) -> u128 {
    (0..n - 1)
