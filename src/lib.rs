...
pub use sim::compiled::{
    ...
    CorrelatorAccumulator, HistogramAccumulator, MarginalsAccumulator, PackedShots, ParityStats,
    PauliExpectationAccumulator, PauliVec, ShotAccumulator, ShotLayout, SparseParity,
};
